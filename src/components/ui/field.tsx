...
// text-base (16px), no text-sm: cualquier campo con letra menor a 16px hace
// que iOS Safari haga zoom automático al enfocarlo — con estudiantes
// entrando su NIP desde el celular, eso importa en el primer formulario
// que ven.
const CAMPO_BASE =
  "w-full rounded-lg border border-slate-300 bg-white px-3.5 py-2.5 text-base text-slate-900 placeholder:text-slate-400 transition-colors focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-400 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-50 dark:placeholder:text-slate-500 dark:focus:border-indigo-400 dark:disabled:bg-slate-800";
