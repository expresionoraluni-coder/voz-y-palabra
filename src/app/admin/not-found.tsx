...
export default function NotFoundAdministrador() {
  return (
    <main className="flex min-h-dvh items-center justify-center px-6 py-10">
      <div className="flex w-full max-w-md flex-col items-center gap-4 rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="flex flex-col gap-1">
          <h1 className="text-lg font-semibold text-slate-900 dark:text-slate-50">No encontramos ese recurso</h1>
          <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">
            La sección administrativa que buscas no existe o ya no está disponible.
          </p>
        </div>
        <Link
          href="/admin"
