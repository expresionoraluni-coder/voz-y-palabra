-- Unifica las respuestas del inicio estudiantil para no revelar si falló
-- el código de grupo, el nombre o el NIP.
-- Esta migración queda versionada para aplicarse en una ventana autorizada.
...
begin
  ...
  if extensions.crypt(p_nip, v_estudiante.nip_hash) <> v_estudiante.nip_hash then
    update public.estudiantes set intentos_fallidos = v_estudiante.intentos_fallidos + 1,
