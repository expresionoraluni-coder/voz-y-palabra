-- Las entregas abiertas también usan la fila única por estudiante/actividad,
-- pero no tienen puntaje automático. Se conservan hasta tres intentos y se
-- devuelve el mejor puntaje cuando existe.
...
begin
  ...
  loop
    ...
    if found then
      ...
      if jsonb_typeof(v_entrega.respuesta -> '_meta') = 'object' then
